...
def send_message(self):
    ...
    main_frame.show_send_message('rufanzhang', content, 'private_chat')
# 发送表情标记函数
def send_mark(exp):
...
def go_to_main_panel(user_name):
    ...
    main_frame = chat_main.MainPanel(user_name, send_message, send_mark, refurbish_user, private_talk, close_main_window)
    # 创建子线程专门负责接收并处理数据
