...
class MainPanel:
    ...
    def show_main_panel(self):
        ...
        # self.p11 = PhotoImage(file='1.png')
        # self.p12 = PhotoImage(file='1.png')
        #
        # # 表情包字典，每一个表情包对应一个标记
        ...
        # 设置文本标签和位置
        self.label1 = Label(self.main_frame, text="    在线用户         创新聊天室欢迎您：" + self.user_name + "   "
                                                                                                      "              "
                                                                                                      "      " +
        ...
        numIdx = 6  # gif的帧数
        # 循环遍历动图的帧
        frames = [ImageTk.PhotoImage(file='bg.gif', format='gif -index %i' % (i)) for i in range(numIdx)]
        # 创建存储gif的标签
    ...
    def clear_chatting_records(self):
        ...
        # 打开聊天记录文件，以覆盖的形式写入内容
        a = open("C:/Program Files (x86)/pythonProject/chatting_records/" + self.user_name + ".txt",
                 'w')
